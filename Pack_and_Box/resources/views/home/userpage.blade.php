                            ...
                            <div class="row align-items-center">
                                ...
                                >
                                    <div class="mb-5">
                                        <h3 class="d-flex align-items-center">
                                            <span
                                                class="icon icon-beach_access mr-2"
                                            ></span
                                            ><span>Design</span>
                                        </h3>
                                        <p>
                                            Partner with our talented design team at the first stage of our process to bring your vision to life. Collaborate with us to finalize your designs, ensuring that every detail is perfect before it goes to print. With our team's expertise and your unique vision, we will create designs that 
                                            stand out and make a lasting impact. Experience seamless communication and unmatched creativity as we work together towards achieving your desired outcomes.
                                        </p>
                                    ...
                                    <div>
                                        <h3 class="d-flex align-items-center">
                                            <span
                                                class="icon icon-build mr-2"
                                            ></span
                                            ><span>Sample</span>
                                        </h3>
                                        <p>
                                            Once the design is approved, we print out samples of your 
                                            final product to test its compatibility, functionality, artwork, etc. When the samples are given the green-light, then we proceed to the next stage of our process.
                                        </p>
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-5">
                                        <h3 class="d-flex align-items-center">
                                            <span
                                                class="icon icon-format_paint mr-2"
                                            ></span
                                            ><span>Print</span>
                                        </h3>
                                        <p>
                                            The printing process starts by developing plates for package design layouts. Then the samples are printed, 
                                            colour tested and sent for approval. Once approved, the mass production phase begins. Quality control screenings are carried out at each stage of the printing process.
                                        </p>
                                    ...
                                    <div>
                                        <h3 class="d-flex align-items-center">
                                            <span
                                                class="icon icon-question_answer mr-2"
                                            ></span
                        ...
                        <div class="testimonial">
                            <blockquote class="mb-5">
                                <p>
                                    ...
                                    unde reprehenderit aperiam quaerat fugiat
                                    repudiandae explicabo animi minima fuga
                                    beatae illum eligendi incidunt consequatur.
                                    Amet dolores excepturi earum unde
                                    iusto.&rdquo;
                                </p>
                            </blockquote>
                        ...
                        >
                            <div class="person text-center bg-white p-4">
                                ...
                                <p class="mb-4">
                                    ...
                                    molestiae quidem provident voluptatum
                                    deleniti quo iste error eos est praesentium
                                    distinctio cupiditate tempore suscipit
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                            <div class="h-entry">
                                ...
                                <h2 class="font-size-regular">
                                    <a href="#"
                                        >Create Beautiful Website In Less Than
                                        An Hour</a
                                    >
                                </h2>
                                <div class="meta mb-4">
